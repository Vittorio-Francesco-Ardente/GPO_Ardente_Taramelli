...
2. 🔍 Verifica la validità del percorso file
3. 🔒 Controlla i permessi di scrittura nella directory
4. 📊 Raggruppa le pizze per tipo usando LINQ
5. 📝 Formatta la riga di log con ID, data/ora e dettaglio pizze
6. 💾 Scrive sul file in modalità append (aggiunge in coda)
7. ✅ Conferma l'avvenuto salvataggio all'utente
